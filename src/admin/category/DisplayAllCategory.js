...
setIcon({byte:'',filename: `${serverURL}/images/${rowData.categorypicture}`})
    ...
    return(
       ...
       <Grid container spacing={2}>
            ...
            <Grid size={6}>
             ...
             <Button fullWidth variant="contained" onClick={handleCategoryEdit}>Edit</Button> 
            </Grid> 
        ...
        return (
          <MaterialTable
            ...
            columns={[
              ...
              { title: 'Icon', render:(rowData)=><img src={`${serverURL}/images/${rowData.categorypicture}`} width={40}/>},
